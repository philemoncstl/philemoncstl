...
public class ReprintReceiptAction extends AbstractAction{
	private static final Logger logger = Logger.getLogger(ReprintReceiptAction.class);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(pnlCur != null && (pnlCur instanceof CpSelectionPanel || pnlCur instanceof HelpPanel)) {		
			ReprintReceiptDialog dialog = new ReprintReceiptDialog(c, false);
